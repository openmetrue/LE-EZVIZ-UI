...
var catalog = map[string]map[string]string{
	"en": {
		...
		"logs.lez": "Bridge (lez.log)", "logs.bridge": "bridge.err", "logs.ezvizd": "ezvizd (journal)",
		...
		"logs.clearConfirm": "Clear lez.log and bridge.err?",
		"maint.clearStats":  "Reset battery history",
		"nav.recordings":    "Videos",
		"live.savedServer":  "Saved on server: ",
		"rec.title":         "Videos",
		"rec.hint":          "Clips saved on this server. Play one here, download it, or delete it.",
		"rec.empty":         "No saved clips yet — press Save on Live.",
		"rec.play":          "Play", "rec.download": "Download", "rec.delete": "Delete",
		"rec.deleteConfirm": "Delete this clip?",
		"rec.deleted":       "Clip deleted.",
		"rec.total":         "Total: %s in %d clips",
	},
	"ru": {
		...
		"logs.lez": "Мост (lez.log)", "logs.bridge": "bridge.err", "logs.ezvizd": "ezvizd (journal)",
		...
		"logs.clearConfirm": "Очистить lez.log и bridge.err?",
		"maint.clearStats":  "Сбросить историю батареи",
		"nav.recordings":    "Видео",
		"live.savedServer":  "Сохранено на сервере: ",
		"rec.title":         "Видео",
		"rec.hint":          "Записи, сохранённые на этом сервере. Можно посмотреть, скачать или удалить.",
		"rec.empty":         "Пока нет записей — нажмите «Сохранить» на вкладке Стрим.",
		"rec.play":          "Смотреть", "rec.download": "Скачать", "rec.delete": "Удалить",
		"rec.deleteConfirm": "Удалить эту запись?",
		"rec.deleted":       "Запись удалена.",
		"rec.total":         "Всего: %s в %d записях",
	},
	"zh": {
		...
		"logs.lez": "桥接 (lez.log)", "logs.bridge": "bridge.err", "logs.ezvizd": "ezvizd (journal)",
		...
		"logs.clear":        "清空日志文件",
		"logs.clearConfirm": "清空 lez.log 和 bridge.err？",
		"maint.clearStats":  "重置电量历史",
		"nav.recordings":    "视频",
		"live.savedServer":  "已保存到服务器：",
		"rec.title":         "视频",
		"rec.hint":          "保存在本服务器上的录像。可在此播放、下载或删除。",
		"rec.empty":         "暂无录像——请在直播页点击保存。",
		"rec.play":          "播放", "rec.download": "下载", "rec.delete": "删除",
		"rec.deleteConfirm": "删除这段录像？",
		"rec.deleted":       "录像已删除。",
		"rec.total":         "共 %d 段，合计 %s",
	},
	"es": {
		...
		"logs.lez": "Puente (lez.log)", "logs.bridge": "bridge.err", "logs.ezvizd": "ezvizd (journal)",
		...
		"logs.clearConfirm": "¿Vaciar lez.log y bridge.err?",
		"maint.clearStats":  "Reiniciar historial de batería",
		"nav.recordings":    "Vídeos",
		"live.savedServer":  "Guardado en el servidor: ",
		"rec.title":         "Vídeos",
		"rec.hint":          "Clips guardados en este servidor. Reprodúcelo, descárgalo o bórralo.",
		"rec.empty":         "Aún no hay clips: pulsa Guardar en Directo.",
		"rec.play":          "Reproducir", "rec.download": "Descargar", "rec.delete": "Borrar",
		"rec.deleteConfirm": "¿Borrar este clip?",
		"rec.deleted":       "Clip borrado.",
		"rec.total":         "Total: %s en %d clips",
	},
	"de": {
		...
		"logs.clearConfirm": "lez.log und bridge.err leeren?",
		"maint.clearStats":  "Akkuhistorie zurücksetzen",
		"nav.recordings":    "Videos",
		"live.savedServer":  "Auf dem Server gespeichert: ",
		"rec.title":         "Videos",
		"rec.hint":          "Auf diesem Server gespeicherte Clips. Ansehen, herunterladen oder löschen.",
		"rec.empty":         "Noch keine Clips — auf Live „Speichern“ drücken.",
		"rec.play":          "Abspielen", "rec.download": "Herunterladen", "rec.delete": "Löschen",
		"rec.deleteConfirm": "Diesen Clip löschen?",
		"rec.deleted":       "Clip gelöscht.",
		"rec.total":         "Gesamt: %s in %d Clips",
	},
	"fr": {
		...
		"logs.lez": "Pont (lez.log)", "logs.bridge": "bridge.err", "logs.ezvizd": "ezvizd (journal)",
		...
		"logs.clearConfirm": "Vider lez.log et bridge.err ?",
		"maint.clearStats":  "Réinit. historique batterie",
		"nav.recordings":    "Vidéos",
		"live.savedServer":  "Enregistré sur le serveur : ",
		"rec.title":         "Vidéos",
		"rec.hint":          "Clips enregistrés sur ce serveur. Lecture, téléchargement ou suppression.",
		"rec.empty":         "Aucun clip — appuyez sur Enregistrer dans Direct.",
		"rec.play":          "Lire", "rec.download": "Télécharger", "rec.delete": "Supprimer",
		"rec.deleteConfirm": "Supprimer ce clip ?",
		"rec.deleted":       "Clip supprimé.",
		"rec.total":         "Total : %s en %d clips",
	},
	"ja": {
		...
		"logs.lez": "ブリッジ (lez.log)", "logs.bridge": "bridge.err", "logs.ezvizd": "ezvizd (journal)",
		...
		"logs.clearConfirm": "lez.log、bridge.err を消去しますか？",
		"maint.clearStats":  "バッテリー履歴をリセット",
		"nav.recordings":    "動画",
		"live.savedServer":  "サーバーに保存しました: ",
		"rec.title":         "動画",
		"rec.hint":          "このサーバーに保存されたクリップ。再生・ダウンロード・削除ができます。",
		"rec.empty":         "保存されたクリップはまだありません。ライブで「保存」を押してください。",
		"rec.play":          "再生", "rec.download": "ダウンロード", "rec.delete": "削除",
		"rec.deleteConfirm": "このクリップを削除しますか？",
		"rec.deleted":       "クリップを削除しました。",
		"rec.total":         "合計: %s（%d 件）",
	},
	"pt": {
		...
		"logs.lez": "Ponte (lez.log)", "logs.bridge": "bridge.err", "logs.ezvizd": "ezvizd (journal)",
		...
		"logs.clearConfirm": "Limpar lez.log e bridge.err?",
		"maint.clearStats":  "Repor histórico da bateria",
		"nav.recordings":    "Vídeos",
		"live.savedServer":  "Salvo no servidor: ",
		"rec.title":         "Vídeos",
		"rec.hint":          "Clipes salvos neste servidor. Reproduza, baixe ou exclua.",
		"rec.empty":         "Nenhum clipe ainda — toque em Salvar no Ao vivo.",
		"rec.play":          "Reproduzir", "rec.download": "Baixar", "rec.delete": "Excluir",
		"rec.deleteConfirm": "Excluir este clipe?",
		"rec.deleted":       "Clipe excluído.",
		"rec.total":         "Total: %s em %d clipes",
	},
}
