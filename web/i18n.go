...
var catalog = map[string]map[string]string{
	"en": {
		...
		"setup.streamHint":          "On demand wakes the camera only while someone is watching Live. Always on keeps the stream running with no viewers, so you can measure how fast the battery drops.",
		"setup.streamSavedOnDemand": "On demand. The camera can sleep when nobody is watching.",
		"setup.streamSavedAlways":   "Always on. The camera stays awake and streaming — watch Battery.",
	...
	"ru": {
		...
		"setup.streamHint":          "По требованию камера просыпается, только пока открыт Стрим. Постоянно держит поток без зрителей — так видно, как быстро садится батарея.",
		"setup.streamSavedOnDemand": "По требованию. Камера может заснуть, если никто не смотрит.",
		"setup.streamSavedAlways":   "Постоянный стрим. Камера не засыпает — смотри вкладку Батарея.",
	...
	"zh": {
		...
		"setup.streamHint":          "按需仅在有人看直播时唤醒摄像机。持续模式即使无人观看也保持推流，用来观察电量下降有多快。",
		"setup.streamSavedOnDemand": "已改为按需。无人观看时摄像机能休眠。",
	...
	"es": {
		...
		"setup.streamHint":          "Bajo demanda despierta la cámara solo mientras alguien mira el directo. Continuo mantiene el vídeo sin espectadores, para medir cómo cae la batería.",
		"setup.streamSavedOnDemand": "Bajo demanda. La cámara puede dormir si nadie mira.",
	...
	"de": {
		...
		"setup.streamHint":          "Bei Bedarf weckt die Kamera nur, solange jemand Live schaut. Dauerhaft hält den Stream ohne Zuschauer, um den Akkuverbrauch zu messen.",
		"setup.streamSavedOnDemand": "Bei Bedarf. Die Kamera darf schlafen, wenn niemand zuschaut.",
	...
	"fr": {
		...
		"setup.streamHint":          "À la demande réveille la caméra seulement pendant qu’on regarde. En continu garde le flux sans spectateur, pour mesurer la batterie.",
		"setup.streamSavedOnDemand": "À la demande. La caméra peut dormir s’il n’y a personne.",
	...
	"ja": {
		...
		"setup.streamHint":          "オンデマンドはライブを見ている間だけカメラを起こします。常時は視聴者がいなくても配信し、バッテリー減少を測れます。",
		"setup.streamSavedOnDemand": "オンデマンド。誰も見ていないとカメラは眠れます。",
	...
	"pt": {
		...
		"setup.streamHint":          "Sob pedido acorda a câmara só enquanto alguém vê o direto. Contínuo mantém o vídeo sem espetadores, para medir a bateria.",
		"setup.streamSavedOnDemand": "Sob pedido. A câmara pode dormir se ninguém estiver a ver.",
